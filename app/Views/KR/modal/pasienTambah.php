                ...
                <form action="#" id="formtambahpasien">
                    <div class="row">
                        ...
                        <div class="form-group col-md-4 col-4">
                            ...
                            <input type="text" class="form-control" name="nomr" placeholder="Nomor MR">
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-8 col-8">
                            ...
                            <input type="text" class="form-control" name="diagnosa_medis" placeholder="Diagnosa Medis">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">Alamat</label>
                        <textarea class="form-control" rows="2" name="alamat" placeholder="Alamat Pasien"></textarea>
                    </div>
            </div>
            </form>
