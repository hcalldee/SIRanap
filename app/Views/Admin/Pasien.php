...
<?= $this->include('Admin/modal/pasien/editPasien'); ?>
<?= $this->include('Admin/modal/pasien/tambahPasien'); ?>
<?= $this->include('Admin/modal/pasien/detailPasien'); ?>
<?= $this->include('Admin/modal/pasien/hapusPasien'); ?>