                ...
                <form action="#" id="formtambahpasien">
                    ...
                    <div class="row">
                        <div class="form-group col-md-3 col-3">
                            ...
                            <select class="custom-select ruang" id=i_pilih-ruang name="ruangan">
                                <option value="" data-id="">Pilih Ruangan</option>
                                <?php foreach ($ruangan as $r) {
                                    if (session()->get('ruangan') == $r['id']) {
                                        $select = 'selected';
                                    } else {
                                        $select = '';
                                    }
                                ?>
                                    <option value="<?= $r['id'] ?>" <?= $select ?> data-id="<?= $r['id']; ?>"><?= $r['nama_ruangan'] ?></option>
                                <?php } ?>
                            </select>
                        </div>
                        <div class="form-group col-md-4 col-4">
                            <label for="example">Kelas</label>
                            <select class="custom-select kategori" id="i_pilih-ketegori" name="kategori">
