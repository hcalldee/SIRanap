    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <h6 class="text-center text-gray-900" id="h_info">Anda Yakin Ingin Hapus Data Ini...?</h6>
            </div>
            </form>
            <div class="modal-footer">
                <button type="button" class="btn btn-danger" id="hapusspesialis">Hapus Data Spesialis</button>
