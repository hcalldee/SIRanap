        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div id="carouselExampleIndicators" class="carousel slide" data-interval="false">
                    ...
                    <div class="d-flex">
                        <a class="fas fa-arrow-circle-left mr-auto" href="#carouselExampleIndicators" role="button" data-slide="prev">
                        </a>
                        <a class="fas fa-arrow-circle-right ml-auto" href="#carouselExampleIndicators" role="button" data-slide="next">
                        </a>
                    </div>
                </div>
            </div>
