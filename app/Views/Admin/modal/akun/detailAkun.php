        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="form-group">
                    <label for="exampleInputEmail1">Akun Milik</label>
                    <input type="text" class="form-control" id="perawat" aria-describedby="emailHelp" disabled>
                </div>
                <div class="form-group">
                    <label for="exampleInputEmail1">foto</label>
                    <input type="text" class="form-control" id="foto" aria-describedby="emailHelp" disabled>
                </div>
            </div>
