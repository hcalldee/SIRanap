                            ...
                            foreach ($ruangan as $r) { ?>
                             <tr>
                                 ...
                                 <td class="text-center">
                                     <button class="btn btn-info detail-<?= $title_slug ?>" data-toggle="modal" data-target="#detail-<?= $title_slug; ?>" data-id="<?= $r['id']; ?>"><i class="fas fa-info-circle"></i></button>
 ...
 <?= $this->include('Admin/modal/ruangan/editRuangan'); ?>
 <?= $this->include('Admin/modal/ruangan/tambahRuangan'); ?>
 <?= $this->include('Admin/modal/ruangan/detailRuangan'); ?>
 <?= $this->include('Admin/modal/ruangan/hapusRuangan'); ?>