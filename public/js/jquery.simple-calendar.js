...
; (function ($, window, document, undefined) {
  ...
  var pluginName = "simpleCalendar",
    defaults = {
      months: ['januari', 'februari', 'maret', 'april', 'mei', 'juni', 'juli', 'agustus', 'september', 'oktober', 'november', 'desember'], //string of months starting from january
      days: ['minggu', 'senin', 'selasa', 'rabu', 'kamis', 'jumat', 'sabtu'], //string of days starting from sunday
